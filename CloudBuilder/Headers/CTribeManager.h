...
#ifndef CloudBuilder_CTribeManager_h
#define CloudBuilder_CTribeManager_h
	...
	public:
		...
		*/
		...
		/**
			...
			"done" : 1
		 */
        void ChangeRelationshipStatus(const CotCHelpers::CHJSON *aOptions, CResultHandler *aHandler);
        DEPRECATED void ChangeRelationshipStatus(CResultHandler *aHandler, const CotCHelpers::CHJSON *aOptions);
		...
		*/
        void ListNetworkFriends(const CotCHelpers::CHJSON* aConfiguration, CResultHandler *aHandler);
        DEPRECATED void ListNetworkFriends(CResultHandler *aHandler, const CotCHelpers::CHJSON* aConfiguration);
		DEPRECATED void ListNetworkFriends(CResultHandler *aHandler, const char *aNetwork, const CotCHelpers::CHJSON* aFriends);
		...
		/**
            ...
            @param aHandler result handler whenever the call finishes (it might also be synchronous)
		*/
        void FindOpponents(const CotCHelpers::CHJSON *aFilter, const char *aDomain, CResultHandler *aHandler);
        DEPRECATED void FindOpponents(CResultHandler *aHandler, const CotCHelpers::CHJSON *aFilter, const char *aDomain="private");

		
private:
		void ListFriendsGCDone(const CCloudResult *result, CHJSON *config, CResultHandler *callNext);
