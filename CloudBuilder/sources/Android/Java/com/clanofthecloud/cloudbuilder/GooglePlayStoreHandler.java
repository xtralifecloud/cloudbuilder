...
import com.clanofthecloud.cloudbuilder.iab.IabResult;
...
public class GooglePlayStoreHandler {
	...
	protected void listProducts(String paramsJson, final long onCompletedHandler) {
		...
		try {
			...
			CloudBuilder.InvokeHandler(onCompletedHandler, EErrorCode.enInternalError, "Decoding param JSON: " + e.getMessage() + ". Check that you have configured all the products for Google Play on the backoffice.");
		}
	}
