package com.clanofthecloud.cloudbuilder.iab;
...
public class IabHelper {
	...
	public void getProductDetails(final ArrayList<String> skus, final CloudResultListener listener) {
		...
		(new Thread(new Runnable() {
			...
			try {
				...
				if (CloudBuilder.sVerboseLog) Log.v(TAG, "Got answer from Google Play: " + skuDetails.toString());
	...
	private Context getApplicationContext() {
		return CloudBuilder.GetContext().getApplicationContext();
	}
