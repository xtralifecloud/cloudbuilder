...
#ifndef CloudBuilder_helpers_h
#define CloudBuilder_helpers_h
...
namespace CloudBuilder {
	using CotCHelpers::cstring;
	using CotCHelpers::owned_ref;
	using CotCHelpers::autoref;
