...
- (id)initWithGlue:(CloudBuilder::CAppStoreHandler *)_glue {
...
- (void)launchPurchase:(NSString *)productId whenComplete:(CloudBuilder::CInternalResultHandler *)complete {
...
// Private
- (const CHJSON*)cotcProductForAppStoreId:(NSString *)appStoreProductId inProductInfo:(const CotCHelpers::CHJSON *)productInfo {
...
- (void)invokeOnMain:(CInternalResultHandler *)handler result:(const CloudBuilder::CCloudResult *)result {
...
- (void)invokePurchaseHandler:(const char *)productId result:(const CloudBuilder::CCloudResult *)result {
	CCloudResult *copy = result->Duplicate();
...
- (void)setCallback:(CloudBuilder::CDelegate<void (SKProductsResponse *, NSError *error)> *)callback forNextRequest:(id)request {
