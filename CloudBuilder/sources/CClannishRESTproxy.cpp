...
namespace CloudBuilder {
	...
	void CClannishRESTProxy::Convert(const CotCHelpers::CHJSON *ajSON, CInternalResultHandler *onFinished) {
	 ...
	 */
	class CClannishRESTProxy::PopEventLoopThread: public CotCHelpers::CThread {
