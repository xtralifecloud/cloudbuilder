...
#ifndef CloudBuilder_CCallback_h
#define CloudBuilder_CCallback_h
...
namespace CloudBuilder {
	...
	public:
		...
		static CotCHelpers::CMutex gStackMutex;
	...
	class CThreadCloud : public CotCHelpers::CThread {
	public:
		CThreadCloud();
		~CThreadCloud();
		CotCHelpers::CHJSON *mJSON;
		bool mBool;
...
#	pragma warning(disable:4355)
	...
	template<class Obj>
	extern inline CInternalResultHandler *MakeBridgeDelegate(Obj *obj, eErrorCode (Obj::*method)(eErrorCode, const CotCHelpers::CHJSON*)) {
		typedef eErrorCode (Obj::*method_t)(eErrorCode, const CotCHelpers::CHJSON*);
		struct ContextDelegate: CInternalResultHandler {
			_BLOCK2(ContextDelegate, CDelegate,
				Obj*, self,
				method_t, method);
