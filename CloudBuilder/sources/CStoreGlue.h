...
#ifndef __CloudBuilder__CStoreGlue__
#define __CloudBuilder__CStoreGlue__
...
namespace CloudBuilder {
	...
	struct CStoreGlue {
		 ...
		 */
		virtual void GetInformationAboutProducts(const CotCHelpers::CHJSON *productIds, CInternalResultHandler *onFinished) = 0;
		 ...
		 */
		virtual void LaunchPurchase(const CotCHelpers::CHJSON *productInfo, CInternalResultHandler *onFinished) = 0;
	};
}
