...
//////////////////////////// Helpers ////////////////////////////
void CloudBuilder::InvokeHandler(CMatchResultHandler *handler, const CCloudResult *result, CMatch *match) {
	if (handler) {
...
void CloudBuilder::InvokeHandler(CMatchResultHandler *handler, eErrorCode code, const char *message) {
	if (handler) {
