...
#ifndef CloudBuilder_CDelegate_h
#define CloudBuilder_CDelegate_h
	...
	public:
		...
		*/
		...
		/**
			...
			You need to release the returned string if not NULL.
		*/
		...
		*/
		 ...
		 * @return a string with tabs, line endings which you must free!
		 */
		char *Print() const;
